	...
	class WPBakeryVisualComposerCssEditor {
		...
		function render() {
			...
			$output .= '<div class="col-xs-5 vc_span5 vc-settings">'
			  ...
			  . '    <label class="vc-checkbox"><input type="checkbox" name="simply" class="vc-simplify" value=""> ' . __( 'Simplify controls', LANGUAGE_ZONE ) . '</label>'
			  . '</div>';
		...
		function getBackgroundImageControl() {
			return '<ul class="vc-image">'
			  . '</ul>'
			  . '<a href="#" class="vc-add-image">' . __( 'Add image', LANGUAGE_ZONE ) . '</a>';
		}

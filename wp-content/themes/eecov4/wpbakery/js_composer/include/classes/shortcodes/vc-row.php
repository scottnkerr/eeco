...
---------------------------------------------------------- */
	public function getColumnControls( $controls, $extended_css = '' ) {
		...
		$controls_layout .= '<br/><a class="set_columns custom_columns" data-cells="custom" data-cells-mask="custom" title="' . __( 'Custom layout', LANGUAGE_ZONE ) . '">' . __( 'Custom layout', LANGUAGE_ZONE ) . '</a> ';
		$controls_move = ' <a class="column_move" href="#" title="' . __( 'Drag row to reorder', LANGUAGE_ZONE ) . '"></a>';
		$controls_delete = '<a class="column_delete" href="#" title="' . __( 'Delete this row', LANGUAGE_ZONE ) . '"></a>';
		$controls_edit = ' <a class="column_edit" href="#" title="' . __( 'Edit this row', LANGUAGE_ZONE ) . '"></a>';
		$controls_clone = ' <a class="column_clone" href="#" title="' . __( 'Clone this row', LANGUAGE_ZONE ) . '"></a>';

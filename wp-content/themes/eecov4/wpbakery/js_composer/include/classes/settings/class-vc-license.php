...
class Vc_License {
	...
	public function adminNoticeLicenseActivation() {
		...
		echo '<div class="updated vc-license-activation-notice"><p>' . sprintf( __( 'Hola! Please <a href="%s">activate your copy</a> of Visual Composer to receive automatic updates.', LANGUAGE_ZONE ), wp_nonce_url( admin_url( 'options-general.php?page=vc_settings&tab=updater' ) ) ) . '</p></div>';
	}
}
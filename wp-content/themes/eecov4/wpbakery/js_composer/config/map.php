...
vc_map( array(
	...
	'base' => 'vc_cta_button2',
	'icon' => 'icon-wpb-call-to-action',
	'category' => array( __( 'Content', LANGUAGE_ZONE ), __( 'New elements', LANGUAGE_ZONE ) ),
	'description' => __( 'Catch visitors attention with CTA block', LANGUAGE_ZONE ),
	'params' => array(
		array(
			'type' => 'textfield',
		...
		array(
			...
			'param_name' => 'content',
			'value' => __( '<p>I am promo text. Click edit button to change this text. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.</p>', LANGUAGE_ZONE )
		),
		array(
			'type' => 'vc_link',
			'heading' => __( 'URL (Link)', LANGUAGE_ZONE ),

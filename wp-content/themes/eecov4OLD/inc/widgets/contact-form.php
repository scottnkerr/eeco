...
class Presscore_Inc_Widgets_ContactForm extends WP_Widget {
	...
	function __construct() {  
		...
		self::$fields_list = array(
			...
			'zip'		=> array( 'title' => _x('Zip Code', 'widget', LANGUAGE_ZONE), 'defaults' => array( 'on' => false, 'required' => false ) ),
	...
	function widget( $args, $instance ) {
		...
		if ( $fields_not_empty ) {
			...
			$button_title = !empty($instance['button_title']) ? $instance['button_title'] : _x('Send', 'widget', LANGUAGE_ZONE);

...
<a href="<?php echo $post->link ?>" class="vc_read_more" title="<?php echo esc_attr(sprintf(__( 'Permalink to %s', LANGUAGE_ZONE ), $post->title_attribute)); ?>"<?php echo $this->link_target ?>><?php _e('Read more', LANGUAGE_ZONE) ?></a>
<?php endif; ?>
...
define( 'WPSEO_VIDEO_VERSION', '3.0' );
...
function wpseo_video_auto_load( $class ) {
	...
	if ( $wpseo_path === null ) {
		if ( defined( 'WPSEO_PATH' ) ) {
			...
			$wpseo_file = str_replace( 'wpseo-video' . DIRECTORY_SEPARATOR . 'video-seo.php', 'wordpress-seo/wp-seo.php', __FILE__ );

			// It might be premium.
			if ( ! file_exists( $wpseo_file ) ) {
				$wpseo_file = str_replace( 'wpseo-video' . DIRECTORY_SEPARATOR . 'video-seo.php', 'wordpress-seo-premium/wp-seo-premium.php', __FILE__ );
			}
